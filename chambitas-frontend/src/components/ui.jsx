...
const DropdownMenuTrigger = forwardRef(({ children, ...props }, ref) => {
  ...
  return (
    <div ref={ref} {...props} onClick={() => setOpen(prev => !prev)}>
      {children}
    </div>
  );
});
...
const DropdownMenuContent = forwardRef(({ className, children, ...props }, ref) => {
  ...
  if (!open) return null;
  return (
    <div ref={ref} {...props} className={cn("absolute right-0 mt-2 w-56 origin-top-right rounded-md shadow-lg bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-50", className)}>
      <div className="py-1">
        {children}
      </div>
    </div>
...
const DropdownMenuItem = forwardRef(({ className, children, ...props }, ref) => {
  return (
    <button ref={ref} {...props} className={cn("w-full text-left block px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700", className)}>
      {children}
    </button>
  );
});
...
const DropdownMenuSeparator = forwardRef(({ className, ...props }, ref) => {
  return <div ref={ref} {...props} className={cn("border-t border-slate-200 dark:border-slate-700 my-1", className)} />;
});
