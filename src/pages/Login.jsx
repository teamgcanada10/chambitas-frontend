...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!success) {
            if (message === 'Por favor, verifica tu correo electrónico antes de iniciar sesión.') {
                setError(message);
            } else {
                    ...
                    <Card className={`rounded-2xl shadow-xl ${glass}`}>
                        ...
                        <CardFooter className="flex flex-col gap-4">
                            ...
                            <p className="text-xs text-center text-slate-500 dark:text-slate-400">
                                ...
                                <Link to="/registro" className="underline font-medium hover:text-primary-600 dark:hover:text-primary-400">
                                    Regístrate aquí
                                </Link>
                            </p>
                        </CardFooter>
